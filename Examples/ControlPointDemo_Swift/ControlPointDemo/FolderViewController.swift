...
class FolderViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        titleLabel.text = DLNAPlayer.sharedInstance.mediaRenderer == nil ? "No Renderer Selected" : DLNAPlayer.sharedInstance.mediaRenderer?.friendlyName
        let barButton = UIBarButtonItem(customView: titleLabel)
//        self.toolbarItems = [DlnaPlayer.sharedInstance.playPauseButton, Player.sharedInstance.stopButton, barButton]
...
//            Player.sharedInstance.startPlayback(playlist: _playlist, position: indexPath.row)
        }
    }
}
